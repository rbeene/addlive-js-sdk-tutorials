...
(function (w) {
  ...
  // To set your own SCOPE_ID (check main.py)
  var SCOPE_ID;

  // To set your own APP_ID (check main.py)
  var APPLICATION_ID;

  // To set your own API_KEY (check main.py)
  var APP_SHARED_SECRET;

  // To get the authentication details (check main.py)
  var AUTH_DETAILS;
  ...
  ADLT.init = function() {
    ...
    AUTH_DETAILS = ADLT.AUTH_DETAILS;
